    ...
    >
      <div className="container mx-auto flex items-center justify-between px-6 md:px-12">
        ...
        {/* Mobile Menu Dropdown */}
          {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full liquid-glass border-b border-white/5 p-6 flex flex-col gap-6 md:hidden shadow-xl">
             {navLinks.map((link) => (
              <a 
                key={link.name} 
                href={link.href} 
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full gap-2 rounded-full bg-gradient-to-r from-emerald-400 via-cyan-400 to-purple-400 px-5 py-3 text-sm font-medium text-white transition-all"
            >
